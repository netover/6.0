...
def get_config_definitions() -> list[ConfigCategory]:
    ...
    return [
        ...
        ConfigCategory(
            name="document_kg",
            display_name="Document Knowledge Graph",
            description="Extração e consulta de grafo de conhecimento a partir de documentos ingeridos",
            icon="fa-diagram-project",
            fields=[
                ConfigField(
                    name="KG_EXTRACTION_ENABLED",
                    value=settings.KG_EXTRACTION_ENABLED,
                    type="bool",
                    description="Habilitar extração de conceitos e relações na ingestão de documentos",
                    default=False,
                    requires_restart=False,
                    category="document_kg",
                    sensitive=False,
                ),
                ConfigField(
                    name="KG_EXTRACTION_MODEL",
                    value=settings.KG_EXTRACTION_MODEL,
                    type="string",
                    description="Modelo LLM para extração (vazio = modelo padrão do sistema)",
                    default="",
                    requires_restart=False,
                    category="document_kg",
                    sensitive=False,
                ...
                ConfigField(
                    name="KG_EXTRACTION_MAX_CONCEPTS",
                    value=settings.KG_EXTRACTION_MAX_CONCEPTS,
                    type="int",
                    description="Máximo de conceitos extraídos por chunk de documento",
                    default=10,
                    min_value=1,
                    max_value=50,
                    requires_restart=False,
                ...
                ConfigField(
                    name="KG_EXTRACTION_MAX_EDGES",
                    value=settings.KG_EXTRACTION_MAX_EDGES,
                    type="int",
                    description="Máximo de relações extraídas por chunk de documento",
                    default=20,
                    min_value=1,
                    max_value=100,
                    requires_restart=False,
                ...
                ConfigField(
                    name="KG_RETRIEVAL_ENABLED",
                    value=settings.KG_RETRIEVAL_ENABLED,
                    type="bool",
                    description="Habilitar enriquecimento de contexto via Knowledge Graph no agente",
                    default=False,
                    requires_restart=False,
                    category="document_kg",
                    sensitive=False,
                ...
                ConfigField(
                    name="KG_RETRIEVAL_DEPTH",
                    value=settings.KG_RETRIEVAL_DEPTH,
                    type="int",
                    description="Profundidade máxima de traversal no grafo (hops)",
                    default=2,
                    min_value=1,
                    max_value=5,
                    requires_restart=False,
                ...
                ConfigField(
                    name="KG_RETRIEVAL_MAX_EDGES",
                    value=settings.KG_RETRIEVAL_MAX_EDGES,
                    type="int",
                    description="Máximo de edges retornados no subgrafo de contexto LLM",
                    default=40,
                    min_value=10,
                    max_value=500,
                    requires_restart=False,
        ...
        ConfigCategory(
            name="startup_health",
            display_name="Startup & Health Checks",
            description="Timeouts, retries, and service requirements for application startup",
            icon="fa-heartbeat",
            fields=[
                ConfigField(
                    name="STARTUP_TCP_CHECK_TIMEOUT",
                    value=settings.STARTUP_TCP_CHECK_TIMEOUT,
                    type="float",
                    description="Timeout (seconds) for TCP reachability checks (TWS, etc.)",
                    default=3.0,
                    min_value=0.5,
                    max_value=30.0,
                    requires_restart=False,
                ...
                ConfigField(
                    name="STARTUP_LLM_HEALTH_TIMEOUT",
                    value=settings.STARTUP_LLM_HEALTH_TIMEOUT,
                    type="float",
                    description="Timeout (seconds) for LLM service health check HTTP request",
                    default=5.0,
                    min_value=1.0,
                    max_value=60.0,
                    requires_restart=False,
                ...
                ConfigField(
                    name="STARTUP_REDIS_HEALTH_RETRIES",
                    value=settings.STARTUP_REDIS_HEALTH_RETRIES,
                    type="int",
                    description="Max retry attempts for Redis connectivity at startup",
                    default=1,
                    min_value=0,
                    max_value=10,
                    requires_restart=False,
                ...
                ConfigField(
                    name="STARTUP_REDIS_HEALTH_TIMEOUT",
                    value=settings.STARTUP_REDIS_HEALTH_TIMEOUT,
                    type="float",
                    description="Timeout (seconds) for Redis health check at startup",
                    default=3.0,
                    min_value=0.5,
                    max_value=30.0,
                    requires_restart=False,
                ...
                ConfigField(
                    name="require_llm_at_boot",
                    value=settings.require_llm_at_boot,
                    type="bool",
                    description="Require LLM service to be reachable for startup to succeed",
                    default=False,
                    requires_restart=True,
                    category="startup_health",
                    sensitive=False,
                ...
                ConfigField(
                    name="require_tws_at_boot",
                    value=settings.require_tws_at_boot,
                    type="bool",
                    description="Require TWS to be reachable for startup to succeed",
                    default=False,
                    requires_restart=True,
                    category="startup_health",
                    sensitive=False,
        ...
        ConfigCategory(
            name="app_factory",
            display_name="App Factory & Lifespan",
            description="Static file caching, template engine, security thresholds, and shutdown behaviour",
            icon="fa-industry",
            fields=[
                ConfigField(
                    name="static_cache_max_age",
                    value=settings.static_cache_max_age,
                    type="int",
                    description="Cache-Control max-age for static files (seconds)",
                    default=3600,
                    min_value=0,
                    max_value=604800,
                    requires_restart=False,
                ...
                ConfigField(
                    name="ETAG_HASH_LENGTH",
                    value=settings.ETAG_HASH_LENGTH,
                    type="int",
                    description="Hex characters from SHA-256 used for ETag (16 = 64-bit uniqueness)",
                    default=16,
                    min_value=8,
                    max_value=64,
                    requires_restart=False,
                ...
                ConfigField(
                    name="SHUTDOWN_TASK_CANCEL_TIMEOUT",
                    value=settings.SHUTDOWN_TASK_CANCEL_TIMEOUT,
                    type="float",
                    description="Timeout (seconds) for cancelling background tasks during shutdown",
                    default=5.0,
                    min_value=1.0,
                    max_value=60.0,
                    requires_restart=False,
                ...
                ConfigField(
                    name="MIN_ADMIN_PASSWORD_LENGTH",
                    value=settings.MIN_ADMIN_PASSWORD_LENGTH,
                    type="int",
                    description="Minimum admin password length enforced in production",
                    default=8,
                    min_value=6,
                    max_value=128,
                    requires_restart=True,
                ...
                ConfigField(
                    name="MIN_SECRET_KEY_LENGTH",
                    value=settings.MIN_SECRET_KEY_LENGTH,
                    type="int",
                    description="Minimum SECRET_KEY length enforced in production",
                    default=32,
                    min_value=16,
                    max_value=256,
                    requires_restart=True,
