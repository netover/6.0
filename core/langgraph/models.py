...
class EntityExtractionOutput(BaseModel):
    ...
    job_name: str | None = Field(
        default=None,
        description="Name of the TWS job mentioned"
    )
    workstation: str | None = Field(
        default=None,
        description="Name of the workstation mentioned"
    )
    action_type: Literal["cancel", "restart", "execute", "hold", "release", "submit"] | None = Field(
        default=None,
        description="Type of action requested"
    )
    error_code: str | None = Field(
        default=None,
        description="Error code mentioned (e.g., AWSB1234E)"
    )
...
class SymptomAnalysis(BaseModel):
    ...
    related_component: str | None = Field(
        default=None,
        description="Related system component"
    )
...
class CauseHypothesis(BaseModel):
    ...
    verification_steps: list[str] = Field(
        ...
        description="Steps to verify this hypothesis"
    )
...
class ActionRequest(BaseModel):
    ...
    requires_approval: bool = Field(
        default=True,
        description="Whether the action requires human approval"
    )
...
class SynthesisInput(BaseModel):
    ...
    raw_data: dict[str, Any] = Field(
        description="Raw data to synthesize"
    )
    intent: Intent = Field(
