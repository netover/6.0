...
async def readiness_probe():
    ...
    """
    # Run critical checks concurrently to reduce probe latency.
    # This prevents a single slow dependency from stalling the readiness endpoint.
    import asyncio
    ...
    all_ready = all(v.get("status") == "ok" for v in checks.values())
