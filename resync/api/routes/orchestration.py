...
async def execute_workflow(
    ...
    """
    try:
        trace_id = await runner.start_execution(config_id, input_data, user_id="api_user") # TODO: get user from auth
...
async def websocket_execute(
    ...
    try:
        ...
        # Start execution
        trace_id = await runner.start_execution(config_id, input_data, user_id="ws_user")
